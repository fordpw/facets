...
const Layout = () => {
  ...
  const navigation = [
    ...
    { name: 'Members', href: '/members', icon: UsersIcon, current: location.pathname.startsWith('/members') },
    { name: 'Providers', href: '/providers', icon: BuildingOfficeIcon, current: location.pathname.startsWith('/providers') },
    { name: 'Claims', href: '/claims', icon: DocumentTextIcon, current: location.pathname.startsWith('/claims') },
    { name: 'Plans', href: '/plans', icon: ClipboardDocumentListIcon, current: location.pathname.startsWith('/plans') },
    { name: 'Employers', href: '/employers', icon: BriefcaseIcon, current: location.pathname.startsWith('/employers') },
      ...
      <div className={`relative z-50 lg:hidden ${sidebarOpen ? '' : 'hidden'}`}>
        ...
        <div className="fixed inset-0 flex">
          <div className="relative mr-16 flex w-full max-w-xs flex-1">
            ...
            <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-healthcare-600 px-6 pb-4">
              <div className="flex h-16 shrink-0 items-center">
                <img className="h-8 w-auto" src="/logo.svg" alt="Healthcare Management" />
                <span className="ml-3 text-white font-semibold text-lg">Healthcare System</span>
              </div>
                        ...
                        <li key={item.name}>
                          <Link
                            ...
                            className={item.current
                              ? 'sidebar-nav-item-active text-white bg-healthcare-700'
                              : 'sidebar-nav-item-inactive text-healthcare-100 hover:text-white hover:bg-healthcare-700'
                            }
              ...
              <div className="relative">
                <div className="flex items-center gap-x-3">
                  <div className="flex-shrink-0">
                    <div className="h-8 w-8 rounded-full bg-healthcare-600 flex items-center justify-center">
                  ...
                  <button
                    type="button"
                    className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 hover:text-gray-700"
